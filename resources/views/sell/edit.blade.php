    ...
    <div class="content-wrapper">
      <div class="row">    
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Update Sell Record</h4>  
              @if (session('status'))
                    ...
                    <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            ...
                            <select class="form-control" name="clientCode" required>
                                <option value="{{ $sells->clientCode }}">{{ $sells->clientCode }}</option>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <select class="form-control" name="script" required>
                            <option value="{{ $sells->script }}">{{ $sells->script }}</option>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="quantity" value="{{ $sells->quantity }}" class="form-control" placeholder="Quantity" required/>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="sellingPrice" value="{{ $sells->sellingPrice }}" class="form-control" placeholder="selling Price" required/>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="row">                    
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <select class="form-control" name="costOnSell" required>
                            <option value="{{ $sells->costOnSell }}">{{ $sells->costOnSell }}</option>                            
                  ...
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="netReceivable" value="{{ $sells->netReceivable }}" class="form-control" placeholder="Net Receivable" required/>
                      </div>
                    </div>
                  </div>                  
                </div>                
