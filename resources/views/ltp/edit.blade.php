    ...
    <div class="content-wrapper">
      <div class="row">    
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <p class="card-title"><a href="{{ route('ltp.list') }}" class="btn btn-primary btn-rounded btn-fw">Cancel Update</a> </p> 
              @if (session('status'))
                ...
                <div class="row">
                  <div class="col-md-8">
                    <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="hidden" name="id" value="{{$ltps->id}}">
                            <select class="form-control" name="script" required>
                                <option value="{{ $ltps->script }}">{{ $ltps->script }}</option>
                ...
                <div class="row">
                  <div class="col-md-8">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8">
                        <input type="text" name="lastTredingPrice" value="{{ $ltps->lastTredingPrice }}" class="form-control" placeholder="Last Treding Price" required/>
                      </div>
                    </div>
                  </div>
                </div>                
